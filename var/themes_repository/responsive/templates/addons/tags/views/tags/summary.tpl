...
<div class="ty-tags-summary">
        ...
        {if $tag.pages}
            ...
            {foreach from=$tag.pages item="tag_page" key="tag_page_id"}
                <li>
                    {include file="buttons/button.tpl" but_href="tags.delete?tag_id=`$tag.tag_id`&object_type=A&object_id=`$tag_page_id`&redirect_url=`$return_current_url`" but_meta="cm-confirm ty-delete-icon" but_role="delete"}
