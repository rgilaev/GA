<div id="content_tags_tab">
    ...
    <div class="ty-tags-form ty-control-group">
        ...
        {else}
            ...
            <a class="ty-btn" href="{if $runtime.controller == "auth" && $runtime.mode == "login_form"}{$config.current_url|fn_url}{else}{"auth.login_form?return_url=`$return_current_url`"|fn_url}{/if}">{__("sign_in_to_enter_tags")}</a>
        {/if}
    </div>
