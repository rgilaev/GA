            ...
            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                ...
                <div class="ty-grid-list__control">
                    <div class="ty-quick-view-button">
                        <a id="opener_gift_cert_picker_{$gift_key}" class="ty-btn ty-btn__big cm-dialog-opener cm-dialog-auto-size" data-ca-target-id="gift_cert_quick_view_{$gift_key}" href="{"gift_certificates.update?gift_cert_wishlist_id=`$gift_key`"|fn_url}" rel="nofollow">{__("quick_view")}</a>
                    </div>
                </div>
            </div>
