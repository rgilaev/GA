        ...
        <div class="ty-checkout__register checkout-register">
            {capture name="register"}
                {if $settings.General.approve_user_profiles != "Y"}
                    <div id="register_checkout" class="ty-checkout-buttons">{include file="buttons/button.tpl" but_onclick="fn_switch_checkout_type();" but_meta="ty-btn__danger" but_text=__("register")}</div>
                {/if}
            {/capture}
