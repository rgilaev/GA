...
{if $items}
    <ul class="ty-menu__items cm-responsive-menu">
        ...
        {foreach from=$items item="item1" name="item1"}
            ...
            {/if}
            <li class="ty-menu__item cm-menu-item-responsive {if !$item1.$childs} ty-menu__item-nodrop{/if} {if $item1.active || $item1|fn_check_is_active_menu_item:$block.type} ty-menu__item-active{/if}">
