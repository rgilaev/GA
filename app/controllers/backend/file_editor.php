...
$_SESSION['active_section'] = empty($_SESSION['active_section']) ? 'files' : $_SESSION['active_section'];
...
function fn_te_get_root($type, $section = 'themes')
{
    if ($section == 'themes') {
        if ($type == 'full') {
            $path = fn_get_theme_path('[themes]/', 'C');
        } elseif ($type == 'rel') {
            $path = fn_get_theme_path('/[relative]/', 'C');
        } elseif ($type == 'repo') {
            $path = fn_get_theme_path('[repo]/', 'C');
        }
